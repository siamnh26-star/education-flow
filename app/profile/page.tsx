    ...
    <div className="min-h-screen bg-[#0a0a0a] p-6">
      <div className="max-w-md mx-auto">
        ...
        <div className="flex flex-col items-center mb-8">
          <div className="w-28 h-28 rounded-full overflow-hidden border-3 border-green-500 glow-green mb-4 bg-black">
            {image ? (
          ...
          <input
            ...
            className="bg-black border border-green-500 p-3 rounded text-green-400 text-sm w-full text-center mb-3"
            value={image}
            onChange={(e) => setImage(e.target.value)}
          />
          
          <p className="text-gray-500 text-xs">Enter any image URL for profile picture</p>
        </div>
