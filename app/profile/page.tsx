...
export default function ProfilePage() {
  ...
  if (status === 'loading') {
    return <div className="min-h-screen bg-[#0a0a0a] flex items-center justify-center text-green-400">Loading...</div>;
  }
    ...
    <div className="min-h-screen bg-[#0a0a0a] p-6">
      <div className="max-w-md mx-auto">
        ...
        <div className="flex flex-col items-center mb-6">
          <div className="w-24 h-24 rounded-full overflow-hidden border-2 border-green-500 glow-green mb-3 bg-black">
            {image ? (
          ...
          <input
            ...
            className="bg-black border border-green-500 p-2 rounded text-green-400 text-sm w-full text-center"
            value={image}
        ...
        <button 
          onClick={handleSave}
          className="w-full bg-green-600 text-black py-3 rounded-lg font-bold hover:bg-green-500 mb-8 transition-all"
        >
