                  ...
                  <>
                    <div className="p-4 border-b border-green-900/50 bg-green-900/10">
                      <div className="flex items-center gap-3 mb-2">
                        ...
                        <div>
                          <p className="text-green-400 font-bold text-sm">{session.user?.name}</p>
                    ...
                    <div className="py-1">
                      ...
                      <Link href="/mycourses" className="flex items-center gap-3 px-4 py-3 hover:bg-green-900/20 text-green-300 transition-colors text-sm">
                        <span className="text-lg">📚</span> 
                        <span>My Courses</span>
                      </Link>
                      <Link href="/admin/dashboard" className="flex items-center gap-3 px-4 py-3 hover:bg-green-900/20 text-green-300 transition-colors text-sm">
