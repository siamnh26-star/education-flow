  ...
  return (
    <div className="p-6">
      <div className="flex justify-between items-center mb-6">
        ...
        <Link to="/admin" className="text-green-400 border border-green-500 px-4 py-2 rounded">
          ← Back to Dashboard
        </Link>
      </div>

      <div className="bg-gray-900 p-4 rounded border border-green-500 mb-6">
        <h3 className="text-xl mb-4">Add New Course</h3>
        <div className="flex gap-3">
          ...
          <button 
            onClick={addCourse}
            className="bg-green-600 text-black px-6 py-2 rounded font-bold"
          >
            Add
          </button>
        </div>
